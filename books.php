    ...
    <div class="content ">
        ...
        <div class="page-header d-md-flex justify-content-between">
            ...
            <div class="mt-2 mt-md-0">
                <a href="#" class="btn btn-outline-primary" title="List" data-toggle="tooltip">
                    <i class="fa fa-th-list"></i>
                </a>
                <a href="#" class="btn btn-outline-primary active ml-2" title="Grid" data-toggle="tooltip">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="text-center">
                                                <a href="book-detail.php?v=<?= $v['slug'] ?>">
                                                    <h4><?= $v['title'] ?> </h4>
                                                </a>

                                                <div class="mt-2">
                                                    <a href="book-detail.php?v=<?= $v['slug'] ?>"> <button class="btn btn-primary add-to-card">Baca</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
